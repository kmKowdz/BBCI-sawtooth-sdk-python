...
from sawtooth_integration.tests.integration_tools import BBCIClient
...
class TestXoSmoke(unittest.TestCase):
    ...
    def test_bbci_smoke(self):
        for username in ('nunzio', 'tony'):
            _send_cmd('sawtooth keygen {}'.format(username))

        game_cmds = (
            'bbci create game-1 --username nunzio',
            'bbci take game-1 1 --username nunzio',
            'bbci take game-1 4 --username tony',
            'bbci take game-1 2 --username nunzio',
            'bbci take game-1 2 --username tony',
            'bbci take game-1 5 --username tony',
            'bbci create game-2 --username tony',
            'bbci take game-2 9 --username nunzio',
            'bbci take game-2 8 --username tony',
            'bbci take game-1 3 --username tony',
            'bbci take game-1 3 --username nunzio',
            'bbci take game-1 7 --username tony',
            'bbci take game-2 6 --username nunzio',
            'bbci create blank --username tony',
        )
        ...
        delete_cmds = (
            'bbci delete game-1 --username nunzio',
            'bbci delete blank --username tony',
        )
        ...
        _send_cmd('bbci list --url {}'.format(self.client.url))
